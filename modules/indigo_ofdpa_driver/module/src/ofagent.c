...
// #include "indigo_ofdpa_driver/ofdpa_util.h"
const char *versionBuf = BUILD_VERSION;
...
int aim_main(int argc, char *argv[])
{
  ...
  of_desc_str_t sw_desc = "OF-DPA 2.0-EA1 for Open Network Linux";
  ind_core_sw_desc_set(sw_desc);

  of_desc_str_t hw_desc = "";
  /* FIXME should get ONIE platform ID here */
  snprintf(hw_desc, sizeof(hw_desc), "powerpc-quanta-ly2-r0");
